...
#Code to collect gene set CNV burden test results for constraint quintiles
...
if [ ${collection} == "effectSize" ]; then
  ...
  done < ${WRKDIR}/bin/rCNVmap/misc/LoF_constraint_quintile_gene_sets.list | \
  paste - - > ${WRKDIR}/data/plot_data/figure3/constraint_quintiles/${CNV}_${VF}_${filt}_${context}.effectSizes.txt
  ...
  paste - - > ${WRKDIR}/data/plot_data/figure3/constraint_quintiles/${CNV}_${VF}_${filt}_${context}.pvals.txt
  ...
  paste - - > ${WRKDIR}/data/plot_data/figure3/constraint_quintiles/${CNV}_${VF}_${filt}_${context}.lowerCI.txt
  ...
  paste - - > ${WRKDIR}/data/plot_data/figure3/constraint_quintiles/${CNV}_${VF}_${filt}_${context}.upperCI.txt
  ...
  paste - - > ${WRKDIR}/data/plot_data/figure3/constraint_quintiles/${CNV}_${VF}_${filt}_${context}.zScore.txt
fi
